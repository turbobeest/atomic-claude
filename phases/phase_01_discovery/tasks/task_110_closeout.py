...
def execute(atomic_root: Path, output_dir: Path, uat_mode: bool = False) -> bool:
    """
    Execute Task 110: Phase Closeout.
    ...
    # Check diagrams
    diagrams_manifest = atomic_root / "docs" / "diagrams" / "manifest.json"
    ...
    # Check audit
    audit_file = atomic_root / ".outputs" / "audits" / "phase-1-report.json"
    if not audit_file.exists():
        audit_file = atomic_root / ".claude" / "audit" / "phase-01-audit.json"
